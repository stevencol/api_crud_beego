...
func (c *ContactoController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddContacto(&v); err == nil {
			...
			c.Data["json"] = map[string]interface{}{"succes": false, "status": "201", "Message": "Error al resgistrar", "Data": err.Error()}
		}
	} else {
		c.Data["json"] = map[string]interface{}{"succes": false, "status": "201", "Message": "Error al resgistrar", "Data": err.Error()}
	}
...
func (c *ContactoController) GetOne() {
	...
	if err != nil {
		c.Data["json"] = map[string]interface{}{"succes": false, "status": "201", "Message": "Error al obtener ", "Data": err.Error()}
	} else {
		c.Data["json"] = map[string]interface{}{"succes": true, "status": "201", "Message": "Se complento el resgistro", "Data": v}
	}
	c.ServeJSON()
...
func (c *ContactoController) GetAll() {
	...
	if err != nil {
		...
		c.Data["json"] = map[string]interface{}{"succes": true, "status": "201", "Message": "Se complento el resgistro", "Data": l}
	}
	c.ServeJSON()
}
...
func (c *ContactoController) Delete() {
	...
	if err := models.DeleteContacto(id); err == nil {
		c.Data["json"] = map[string]interface{}{"succes": false, "status": "201", "Message": "se elimino ", "Data": id}
	} else {
		c.Data["json"] = map[string]interface{}{"succes": false, "status": "201", "Message": "Error al obtener ", "Data": err.Error()}
	}
	c.ServeJSON()
